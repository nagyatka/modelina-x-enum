    ...
    static mergeItems(mergeTo, mergeFrom, originalInput, alreadyIteratedModels = new Map()) {
        ...
        if (Array.isArray(mergeFrom.items) && Array.isArray(mergeToItems)) {
            for (const [index, mergeFromTupleModel] of mergeFrom.items.entries()) {
                mergeTo.items[Number(index)] = CommonModel.mergeCommonModels(mergeToItems[Number(index)], mergeFromTupleModel, originalInput, alreadyIteratedModels);
            }
        }
