...
class FileHelpers {
     ...
     */
    static writerToFileSystem(content, filePath) {
        return __awaiter(this, void 0, void 0, function* () {
            const outputFilePath = path.resolve(filePath);
            // eslint-disable-next-line security/detect-non-literal-fs-filename
            yield fs.promises.mkdir(path.dirname(outputFilePath), { recursive: true });
            // eslint-disable-next-line security/detect-non-literal-fs-filename
            yield fs.promises.writeFile(outputFilePath, content);
        });
    }
}
